...
indexList2 = ['Index', 'Programme','Q3' ,'Q1', 'Gender']
...
test_labels =agg_clustering.fit_predict(X2)
...
plt.xlabel('t-SNE component 1')
plt.ylabel('t-SNE component 2')
plt.title('t-SNE visualization of Hierical Clustering True Labels with Decision Boundaries')
plt.show()
